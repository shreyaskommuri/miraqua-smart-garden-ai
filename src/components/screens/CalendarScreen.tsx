...
const CalendarScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="fixed top-[64px] left-0 right-0 z-40 bg-white border-b border-gray-200 shadow-sm lg:ml-64 lg:top-0 -mt-px">
      ...
      <div className="h-[calc(100vh-128px)] mt-16">
        {/* Calendar Section */}
