    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white/90 backdrop-blur-sm border-b border-gray-200 fixed top-0 left-0 right-0 z-40 shadow-sm">
        <div className="px-4 py-3">
          ...
          <p className="text-sm text-gray-600">Track your garden's performance</p>
        </div>
      </header>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-0">
                <CardContent className="p-4">
                  ...
                  <div className="text-xl font-bold text-blue-900 mb-1">42.3L</div>
                  <div className="text-xs text-blue-700">Water Used</div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-green-50 to-green-100 border-0">
                <CardContent className="p-4">
                  ...
                  <div className="text-xl font-bold text-green-900 mb-1">95%</div>
                  <div className="text-xs text-green-700">Plant Health</div>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="border-0 shadow-md">
              <CardHeader className="pb-3">
                <CardTitle className="text-base">Garden Overview</CardTitle>
              </CardHeader>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-orange-50 rounded-xl">
                    ...
                    <div className="text-lg font-bold text-orange-900">73°F</div>
                  ...
                  <div className="text-center p-4 bg-blue-50 rounded-xl">
                    ...
                    <div className="text-xs text-blue-700">Avg Humidity</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 bg-gradient-to-r from-purple-500 to-indigo-600 text-white shadow-lg">
              <CardContent className="p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-xl font-bold mb-1">23.5L</div>
                    <div className="text-xs opacity-90">Water Saved</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold mb-1">$12.40</div>
